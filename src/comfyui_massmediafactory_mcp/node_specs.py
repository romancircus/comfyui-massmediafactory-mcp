...
NODE_SPECS = {
    ...
    # Wan 2.1/2.2 WanVideoWrapper Nodes
    "WanVideoModelLoader": {
        "class": "WanVideoModelLoader",
        "inputs": {
            "model": "STRING",
            "base_precision": "STRING (bf16)",
            "quantization": "STRING (fp8_e4m3fn_scaled|disabled)",
            "load_device": "STRING (offload_device)",
        },
        "outputs": ["WANVIDEOMODEL"],
        "category": "wan",
    },
    "WanVideoVAELoader": {
        "class": "WanVideoVAELoader",
        "inputs": {"model_name": "STRING (wan_2.1_vae.safetensors)", "precision": "STRING (bf16)"},
        "outputs": ["WANVAE"],
        "category": "wan",
    },
    "LoadWanVideoT5TextEncoder": {
        ...
        "inputs": {
            "model_name": "STRING (umt5_xxl_fp16.safetensors)",
            "precision": "STRING (bf16)",
            "load_device": "STRING (offload_device)",
        },
        "outputs": ["WANTEXTENCODER"],
        "category": "wan",
    },
    "LoadWanVideoClipTextEncoder": {
        "class": "LoadWanVideoClipTextEncoder",
        "inputs": {
            "model_name": "STRING (clip_vision_h.safetensors)",
    ...
    "WanVideoClipVisionEncode": {
        ...
        "outputs": ["WANVIDIMAGE_CLIPEMBEDS"],
        "category": "wan",
    },
    "WanVideoImageToVideoEncode": {
        ...
        "outputs": ["WANVIDIMAGE_EMBEDS"],
        "category": "wan",
    },
    "WanVideoEmptyEmbeds": {
        "class": "WanVideoEmptyEmbeds",
        "inputs": {"width": "INT", "height": "INT", "num_frames": "INT"},
        "outputs": ["WANVIDIMAGE_EMBEDS"],
        "category": "wan",
        "notes": "Used for T2V (no image input). Generates empty image embeds.",
    },
    "WanVideoSampler": {
    ...
    "WanVideoDecode": {
        ...
        "inputs": {"vae": "WANVAE", "samples": "LATENT", "enable_vae_tiling": "BOOLEAN"},
        "outputs": ["IMAGE"],
        "category": "wan",
    },
