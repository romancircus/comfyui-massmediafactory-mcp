...
class TestSuite:
    ...
    def get_summary(self) -> Dict[str, Any]:
        ...
        if mcp_results and direct_results:
            ...
            summary["overhead_pct"] = ((mcp_avg_time - direct_avg_time) / direct_avg_time * 100) if direct_avg_time > 0 else 0
            ...
            with self._timed_execution(test_name, "mcp-server", "mcp") as result:
                try:
                    ...
                    wf = gen.generate_workflow(
                        ...
                        prompt=prompt,
                        width=512, height=512,  # Smaller for benchmark speed
                        **extra_params
                    )
    ...
    def generate_report(self) -> str:
        ...
        for suite in self.suites:
            ...
            if 'mcp_avg_time_ms' in summary:
                ...
                report_lines.extend([
                    f"| Metric | MCP | Direct API | Overhead |",
                    f"|--------|-----|------------|----------|",
            ...
            if suite.results:
                report_lines.extend([
                    "#### Detailed Results",
                    "",
                    f"| Test | Method | Duration | Tokens | VRAM | Status |",
                    f"|------|--------|----------|--------|------|--------|",
                ])
...
def main():
    ...
    parser.add_argument(
        "--test",
        choices=["single", "batch", "token", "memory", "all"],
        default="all",
