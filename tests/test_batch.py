...
class TestBatchExecute:
    ...
    def test_batch_mode_success(self, mock_batch):
        ...
        mock_batch.execute_batch.return_value = {
            "results": [{"prompt_id": "batch-1"}, {"prompt_id": "batch-2"}],
            "success": True,
        }

        workflow = {"1": {"class_type": "TestNode"}}
        parameter_sets = [{"seed": 1, "cfg": 3.5}, {"seed": 2, "cfg": 4.0}]

        result = batch_execute(workflow=workflow, mode="batch", parameter_sets=parameter_sets, parallel=1)
    ...
    def test_sweep_mode_success(self, mock_batch):
        ...
        result = batch_execute(workflow=workflow, mode="sweep", sweep_params=sweep_params, fixed_params={"steps": 20})
    ...
    def test_seeds_mode_success(self, mock_batch):
        ...
        result = batch_execute(workflow=workflow, mode="seeds", num_variations=3, start_seed=42)
    ...
    def test_invalid_mode(self):
        ...
        result = batch_execute(workflow=workflow, mode="invalid_mode")
    ...
    def test_batch_missing_parameter_sets(self, mock_batch):
        ...
        result = batch_execute(workflow=workflow, mode="batch")
    ...
    def test_sweep_missing_sweep_params(self, mock_batch):
        ...
        result = batch_execute(workflow=workflow, mode="sweep")
    ...
    def test_batch_parallel_execution(self, mock_batch):
        ...
        mock_batch.execute_batch.return_value = {
            "results": [{"prompt_id": f"parallel-{i}"} for i in range(4)],
            "success": True,
        }
        ...
        result = batch_execute(workflow=workflow, mode="batch", parameter_sets=parameter_sets, parallel=2)
