...
class TestUploadImage:
    ...
    @patch("comfyui_massmediafactory_mcp.server._validate_path")
    @patch("comfyui_massmediafactory_mcp.server.execution")
    def test_upload_success(self, mock_execution, mock_validate):
        """Test successful image upload"""
        # Mock path validation to bypass the check
    ...
    @patch("comfyui_massmediafactory_mcp.server._validate_path")
    @patch("comfyui_massmediafactory_mcp.server.execution")
    def test_upload_with_subfolder(self, mock_execution, mock_validate):
        ...
        result = upload_image("/home/user/images/test.png", "test.png", subfolder="inputs")
...
class TestDownloadOutput:
    ...
    @patch("comfyui_massmediafactory_mcp.server._validate_path")
    @patch("comfyui_massmediafactory_mcp.server.execution")
    def test_download_success(self, mock_execution, mock_validate):
        """Test successful download"""
        # Mock path validation to bypass the check
        mock_validate.return_value = (True, "/home/user/downloads/asset-123.png")
